      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => LoginWidget(
            passwordParam: params.getParam('passwordParam', ParamType.String),
            emailPassword: params.getParam('emailPassword', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'createAccount',
        ...
        FFRoute(
          name: 'addChatUsersCopy',
          path: '/addChatUsersCopy',
          asyncParams: {
            'chat': getDoc(['chats'], ChatsRecord.fromSnapshot),
          },
          builder: (context, params) => AddChatUsersCopyWidget(
            chat: params.getParam('chat', ParamType.Document),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'loads')
              : LoadsWidget(
                  pageLoad: params.getParam('pageLoad', ParamType.bool),
                ),
        ),
        FFRoute(
          name: 'loadDetails',
          path: '/loadDetails',
          builder: (context, params) => LoadDetailsWidget(
            loadDetailsParam:
                params.getParam('loadDetailsParam', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'truckroutes',
          path: '/truckroutes',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'truckroutes')
              : TruckroutesWidget(
                  pageLoad: params.getParam('pageLoad', ParamType.bool),
                ),
        ),
        FFRoute(
          name: 'pickupDetails',
          path: '/pickupDetails',
          builder: (context, params) => PickupDetailsWidget(
            pickupItemParam: params.getParam('pickupItemParam', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'pickups',
          path: '/pickups',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'pickups')
              : PickupsWidget(
                  pageLoad: params.getParam('pageLoad', ParamType.bool),
                ),
        )
