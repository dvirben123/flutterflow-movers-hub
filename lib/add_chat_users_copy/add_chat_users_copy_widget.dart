...
import 'add_chat_users_copy_model.dart';
export 'add_chat_users_copy_model.dart';

class AddChatUsersCopyWidget extends StatefulWidget {
  const AddChatUsersCopyWidget({
    super.key,
    this.chat,
  });
  ...
  @override
  _AddChatUsersCopyWidgetState createState() => _AddChatUsersCopyWidgetState();
}

class _AddChatUsersCopyWidgetState extends State<AddChatUsersCopyWidget> {
  late AddChatUsersCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddChatUsersCopyModel());
